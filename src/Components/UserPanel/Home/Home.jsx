  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen flex flex-col items-center justify-center pt-0">
      ...
      <div className="mb-8 ml-20 pl-20 pt-0 mt-0">
        <h1 className="text-2xl font-bold">Welcome Tanishk</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-8">
        {/* Open Tickets */}
        <div className="bg-green-300 p-6 m-6 rounded-lg shadow-md">
        ...
        {/* Closed Tickets */}
        <div className="bg-red-300 p-6 m-6 rounded-lg shadow-md">
        ...
        <div className="bg-blue-300 p-6 m-6 rounded-lg shadow-md flex items-center justify-center">
          <button
